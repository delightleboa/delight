...
from wyzepal import WyzePalError
if six.PY2:
...
class TestDefaultArguments(TestCase):
    ...
    def test_invalid_arguments(self):
        # type: () -> None
        parser = wyzepal.add_default_arguments(argparse.ArgumentParser(usage="lorem ipsum"))
...
WyzePal API configuration:
  --site WYZEPAL_SITE     WyzePal server URI
"""))
    ...
    def test_config_path_with_tilde(self, mock_os_path_exists):
        ...
        with self.assertRaises(WyzePalError) as cm:
            wyzepal.init_from_options(args)
